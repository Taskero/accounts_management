defmodule AccountsManagementAPIWeb.CoreComponents do
  @moduledoc """
  ...
  def translate_error({msg, opts}) do
    ...
    if count = opts[:count] do
      Gettext.dngettext(AccountsManagementAPIWeb.Gettext, "errors", msg, msg, count, opts)
    else
      Gettext.dgettext(AccountsManagementAPIWeb.Gettext, "errors", msg, opts)
    end
  end
